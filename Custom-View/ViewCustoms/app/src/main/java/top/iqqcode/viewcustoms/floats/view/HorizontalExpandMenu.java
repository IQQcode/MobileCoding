package top.iqqcode.viewcustoms.floats.view;
...
/**
 * https://juejin.cn/post/6844903533595066376
 */
public class HorizontalExpandMenu extends RelativeLayout {
    ...
    private void init() {
        ...
        defaultWidth = UtilHelper.INSTANCE.dip2px(mContext, 200F);
        defaultHeight = UtilHelper.INSTANCE.dip2px(mContext, 40F);
        ...
        menuCornerRadius = typedArray.getDimension(R.styleable.HorizontalExpandMenu_corner_radius, UtilHelper.INSTANCE.dip2px(mContext, 20));

        buttonStyle = typedArray.getInteger(R.styleable.HorizontalExpandMenu_button_style, Right);
        buttonIconDegrees = 90;
        buttonIconSize = typedArray.getDimension(R.styleable.HorizontalExpandMenu_button_icon_size, UtilHelper.INSTANCE.dip2px(mContext, 8));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (getChildCount() > 0) {
            ...
            if (isExpand) {
                ...
                @SuppressLint("DrawAllocation") LayoutParams layoutParams = new LayoutParams(viewWidth, viewHeight);
