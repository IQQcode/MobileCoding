...
import top.iqqcode.custombase.util.Utils;
...
public class HorizontalExpandMenu extends RelativeLayout {
    ...
    private void init() {
        ...
        defaultWidth = Utils.dip2px(mContext, 200F);
        defaultHeight = Utils.dip2px(mContext, 40F);
        ...
        menuCornerRadius = typedArray.getDimension(R.styleable.HorizontalExpandMenu_corner_radius, Utils.dip2px(mContext, 20));

        buttonStyle = typedArray.getInteger(R.styleable.HorizontalExpandMenu_button_style, Right);
        buttonIconDegrees = 90;
        buttonIconSize = typedArray.getDimension(R.styleable.HorizontalExpandMenu_button_icon_size, Utils.dip2px(mContext, 8));
