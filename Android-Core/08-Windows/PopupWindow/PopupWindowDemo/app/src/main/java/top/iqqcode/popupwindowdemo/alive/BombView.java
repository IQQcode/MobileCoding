package top.iqqcode.popupwindowdemo.alive;
...
public class BombView extends View {
    ...
    private final int bombColor = Color.parseColor("#88B0E8");
    private final int bombLineColor = Color.parseColor("#181D82");
    private final int bombShadowColor = Color.parseColor("#77609ee6");
    private final int lightColor = Color.WHITE;
    ...
    private float bombLRRotate = 15;
    private final float bombMaxLRRotate = 15;
    private float bombTBRotate = 0;
    private final float bombMaxTBRotate = 5;
    ...
    private OnBombAnimatorListener mOnBombAnimatorListener;

    public void setOnBombAnimatorListener(OnBombAnimatorListener onBombAnimatorListener) {
        this.mOnBombAnimatorListener = onBombAnimatorListener;
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        float[] highLightFloat = new float[] {
                0
                , getRadianLength(95, highLightRadius)
    ...
    public void startAnim() {
        ...
        set.start();
//        if (mOnBombAnimatorListener != null) {
//            mOnBombAnimatorListener.onAnimationStart();
//        }
    }
    ...
    private ValueAnimator getBlastAnim() {
        ...
        valueAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                invalidate();
                if (mOnBombAnimatorListener != null) {
                    mOnBombAnimatorListener.onAnimationEnd();
                }
            }
        });
        return valueAnimator;
    ...
    public interface OnBombAnimatorListener {
