...
class RoundCornerTransform constructor(
    context: Context, leftTop: Float = 0f,
    rightTop: Float = 0f,
    rightBottom: Float = 0f,
    leftBottom: Float = 0f
) : BitmapTransformation() {

    private val CLASSID = "com.bumptech.glide.transformations.FillSpace"

    private val ID: String =
        CLASSID + "$leftTop$rightTop$leftBottom$rightBottom"
    ...
    // dp转px
    private fun dip2px(var0: Context, var1: Float): Int {
    ...
    override fun equals(other: Any?): Boolean {
        if (other is RoundCornerTransform) {
